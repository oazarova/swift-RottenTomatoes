...
class BoxOfficeMoviesViewController: UIViewController, UITableViewDataSource{
    ...
    func pullData(){
        ...
        let RottenTomatoesURLString = "http://api.rottentomatoes.com/api/public/v1.0/lists/movies/in_theaters.json?apikey=" + YourApiKey
...
// UITabBarDelegate
extension BoxOfficeMoviesViewController: UITabBarDelegate {
